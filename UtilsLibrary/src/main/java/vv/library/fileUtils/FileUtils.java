package vv.library.fileUtils;

import android.content.Context;
import android.os.Environment;
import vv.library.basicUtils.BasicUtils;
...
public class FileUtils {
    ...
    /**
     * rename file name
     * @param oldPath file old name
     * @param newPath file new name
     * @return is rename success or not
     */
    ...
    /**
     * check external storage is usable
     * @return
     */
    ...
    /**
     * get root external storageDirectory path
