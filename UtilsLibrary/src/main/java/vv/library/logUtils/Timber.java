...
public final class Timber {
  ...
  /** A that delegates to all planted trees in the {@link #FOREST forest}. */
  ...
  /** A for debug builds. Automatically infers the tag from the calling class. */
  ...
  /** A  which does nothing. Useful for extending. */
