package com.vv.map.https;


import com.vv.map.interf.IDeuMapHttpCallBack;
 ...
 * <p>Description: 联网操作以及联网所需参数设置</p>
 * @ClassName HttpClientOptions
 * @Package com.ljdy.https
 * @Author S_sxl
 * @Time 2016/4/12
 */
public class HttpClientOptions {
    private String mUrl = DeuMapConstants.ROOT_URL;
     ...
     */
    public void doGet(String url,IDeuMapHttpCallBack callBack){
     ...
     * @param callBack [联网操作的监听接口]
     */
    public void doPost(String url,byte[] request,IDeuMapHttpCallBack callBack){
     ...
     * @param callBack [联网操作的监听接口]
     */
    private byte[] connectToServer(String url,byte[] request,boolean isGet,IDeuMapHttpCallBack callBack){
